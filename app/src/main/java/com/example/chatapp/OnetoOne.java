...
public class OnetoOne extends AppCompatActivity {
    ...
    private mydatabase db = new mydatabase(this); private ListView Lst_Chat;
    private EditText txt_msg;
    private ArrayList<msg_class> onlineMessages = new ArrayList<>(); private ArrayList<msg_class> offlineMessages = new ArrayList<>();
    private ArrayList<String> profile = new ArrayList<>();
    private LinearLayout layout_translateSettings; private CheckBox cb_enableT;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (userId.compareTo(partnerId) >= 0) chatRoomId = userId + "-" + partnerId;
            else
                    ...
                    .addOnFailureListener(
                            new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    ...
                                    int i = 0;
                                    for (StackTraceElement ste : e.getStackTrace()) {
                                        if (ste.getClassName().contains(activityName)) break;
                                        i++;
                                    }
                                    String lineError = e.getStackTrace()[i].getLineNumber() + "";
                                    String msg = e.getMessage();
    ...
    class Listadapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            String g;
            if (offlineMessages.get(position).userGender.matches("Male")) g = " ,M";
            else
                g = " ,F";
