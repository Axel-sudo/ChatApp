...
// public my database context
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            // public ArrayList<String> getProfile(String qry)
            ...
            String functionName = Objects.requireNonNull(new Object(){}.getClass().getEnclosingMethod()).getName();
            int i = 0;
